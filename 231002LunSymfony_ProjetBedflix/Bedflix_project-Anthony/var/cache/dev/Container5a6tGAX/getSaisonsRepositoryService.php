 ...
 */
class getSaisonsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SaisonsRepository' shared autowired service.
     *
     * @return \App\Repository\SaisonsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SaisonsRepository.php';

        return $container->privates['App\\Repository\\SaisonsRepository'] = new \App\Repository\SaisonsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
