 ...
 */
class getEpisodesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EpisodesRepository' shared autowired service.
     *
     * @return \App\Repository\EpisodesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EpisodesRepository.php';

        return $container->privates['App\\Repository\\EpisodesRepository'] = new \App\Repository\EpisodesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
